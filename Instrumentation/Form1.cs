        ...
        public Form1()
        {
            ...
            listBox1.SelectedIndexChanged += (s, a) =>
            {
                if (cont == 1)
                {
                    ...
                    {
                        richTextBox1.Text = "Используется главный приём игры — áрко, при котором звукоиз-влечение совершается ведением волоса смычка по струне. Этот приём игры ис-пользуется по умол-чанию при отсутствии указаний на другой основной приём — пиццикато, коль ле-ньо, коль леньо тратто";
            ...
            listBox1.SelectedIndexChanged += (s, a) =>
            {
                if (cont == 2)
                {
                    ...
                    {
                        //2
                        richTextBox1.Text = "Каждая струна звучит в своём низком реги-стре, поскольку левая рука находится в низ-кой позиции \r\rПриём игры — арко";
                    ...
                    {
                        //3
                        richTextBox1.Text = "Первая струна звучит в своём низком реги-стре (низкая позиция левой руки), вторая — в среднем (средняя позиция), третья — в высоком (высокая по-зиция) \r\rПриём игры — арко";
                    ...
                    {
                        //4
                        richTextBox1.Text = "Вторая струна звучит в своём низком реги-стре (низкая позиция левой руки), третья — в среднем (средняя позиция), четвёртая — в высоком (высо-кая позиция) \r\rПриём игры — арко";
                    ...
                    {
                        //7
                        richTextBox1.Text = "Сурди́на — это при-способление в форме гребешка, шайбы или бабочки, надеваемое на подставку или приставляемое к ней со стороны подгриф-ника. Наиболее круп-ные сурдины из ме-талла или резины в форме гребешка называются глушите-лями и используются в основном в быто-вых, а не художе-ственных целях" +
                                            "\r\rКак правило, компо-зиторы не уточняют в нотах материал сур-дины, хотя от него зависит итоговое зву-чание.Установка сурдины обозначается con sord., снятие — senza sord. или via sord." +
                                            "\r\rПриём игры — арко";
                    ...
                    {
                        //10
                        richTextBox1.Text = "При флаутáндо смы-чок очень легко каса-ется струны и ведётся с высокой скоростью \r\rЗдесь флаутандо ис - полняется на основе арко";
                    ...
                    else if (listBox1.SelectedIndex < 44)
                    {
                        ...
                        {
                            pictureBox1.Image = Resources._211_3__Пережим_усиливающийся;
                        }
                    ...
                    {
                        //12
                        richTextBox1.Text = "Вибрáто образуется при периодических колебаниях звука по высоте, громкости и тембру. Один из па-раметров всегда пре-обладает, у струнных инструментов — вы-сота. На смычковых инструментах вибра-то исполняется коле-бательным движени-ем левой руки или её части, которое пере-даётся пальцу, при-жимающему струну \r\rЗдесь вибрато испол-няется на основе арко";
                    ...
                    else if (listBox1.SelectedIndex < 58)
                    {
                        ...
                        {
                            richTextBox1.Text = "Исполняется перио-дическими движениями пальца левой руки, в то вре-мя как смычок ведёт-ся в одном направле-нии по одной и той же струне \r\rЗдесь тремоло испол - няется на основе арко";
                            pictureBox1.Image = Resources._213_1__Тремоло_левой_рукой;

                        }
                        else if (listBox1.SelectedIndex < 57)
                        {
                            richTextBox1.Text = "Исполняется чередо-ванием направления ведения смычка, в то время как пальцы ле-вой руки прижимают необходимые струны и остаются непо-движными \r\rЗдесь тремоло испол-няется на основе арко";
                    ...
                    {
                        //14
                        richTextBox1.Text = "Флажолéт — это при-ём игры, который ис-полняется лёгким прикосновением пальца к струне в точке её деления на несколько равных от-резков. Прикоснове-ние само по себе не производит звукоиз-влечение и в данном случае осуществляет-ся вместе с арко. В результате извлекает-ся какой-либо обер-тон. Кроме того, флажолетом называ-ется сам извлекаемый обертон \r\rПрикосновение к струне в точке её де-ления на два равных отрезка приводит к извлечению октавно-го обертона (и звуча-нию струны на октаву выше). Прикоснове-ние в одной из точек деления на три рав-ных отрезка приводит к извлечению квинто-вого обертона (и зву-чанию струны на дуодециму выше) и т. д.";
                    ...
                    {
                        //15
                        richTextBox1.Text = "Глиссандо выполня-ется с помощью пере-движения пальца ле-вой руки вдоль стру-ны \r\rЗдесь глиссандо и флажолеты исполня-ются на основе арко";
                    ...
                    {
                        //16
                        richTextBox1.Text = "Натуральный флажо-лет исполняется на открытой струне, ис-кусственный — на закрытой: один палец прижимает струну, а другой одновременно к ней прикасается  \r\rЗдесь флажолеты ис-полняются на основе арко";
                    ...
                    {
                        //17
                        richTextBox1.Text = "Здесь флажолеты ис-полняются на основе арко";
                        pictureBox1.Image = Resources._217__Хроматическая_гамма_искусственными_флажолетами;
                    }
                    else if (listBox1.SelectedIndex < 69)
                    {
                        //18
                        richTextBox1.Text = "По умолчанию глис-сандо выполняется с помощью передвиже-ния пальца левой ру-ки вдоль прижимае-мой им струн \r\rПриём игры — арко";
                    ...
                    else if (listBox1.SelectedIndex < 80)
                    {
                        ...
                        {
                            richTextBox1.Text = "Атака звуков мягкая, сглаженная. Между звуками нет паузы. Смычок не отрывает-ся от струн. Несколь-ко звуков исполняет-ся на одном направ-лении ведения смыч-ка \r\rПриём игры — арко";
                        ...
                        {
                            richTextBox1.Text = "Атака звуков под-чёркнутая, смягчён-ная. Между звуками есть микропауза. Смычок не отрывает-ся от струн. Несколь-ко звуков исполняет-ся на одном направ-лении ведения смыч-ка \r\rПриём игры — арко";
                            pictureBox1.Image = Resources._219_3__Короткое_портато;
                        }
                        else if (listBox1.SelectedIndex < 74)
                        {
                            richTextBox1.Text = "Атака звуков отчёт-ливая. Между звука-ми нет паузы. Смы-чок не отрывается от струн. Каждый сле-дующий звук испол-няется другим направлением веде-ния смычка (пооче-рёдно вниз и вверх) \r\rПриём игры — арко";
                            pictureBox1.Image = Resources._219_4__Деташе;
                        }
                        else if (listBox1.SelectedIndex < 75)
                        {
                            richTextBox1.Text = "Атака звуков под-чёркнутая или акцентированная. Между звуками есть микропауза. Смычок не отрывается от струн.Каждый сле-дующий звук испол-няется другим направлением веде - ния смычка(пооче - рёдно вниз и вверх) \r\rПриём игры — арко";
                            pictureBox1.Image = Resources._219_5__Маркато;
                        }
                        else if (listBox1.SelectedIndex < 76)
                        {
                            richTextBox1.Text = "Атака звуков острая и акцентированная.Между звуками есть пауза. Смычок не от - рывается от струн. Каждый следующий звук исполняется дру - гим направлением ведения смычка(по - очерёдно вниз и вверх) \r\rПриём игры — арко";
                            pictureBox1.Image = Resources._219_6__Мартле;
                        }
                        else if (listBox1.SelectedIndex < 77)
                        {
                            richTextBox1.Text = "Атака звуков очень острая. Между звука-ми есть пауза. Смы-чок отскакивает от струн. Каждый сле-дующий звук испол-няется другим направлением веде-ния смычка (пооче-рёдно вниз и вверх) \r\rПриём игры — арко";
                            pictureBox1.Image = Resources._219_7__Спиккато;
                        }
                        else if (listBox1.SelectedIndex < 78)
                        {
                            richTextBox1.Text = "Атака звуков твёрдая. Между звуками есть пауза. Смычок не от-рывается от струн. Несколько звуков ис-полняется на одном направлении ведения смычка \r\rПриём игры — арко";
                            pictureBox1.Image = Resources._219_8__Стаккато;
                        }
                        else if (listBox1.SelectedIndex < 79)
                        {
                            richTextBox1.Text = "Атака звуков плотная, твёрдая. Между зву-ками есть пауза. Смычок отрывается от струн \r\rПриём игры — арко";
                            pictureBox1.Image = Resources._219_9__Всё_вниз;
                        }
                        else if (listBox1.SelectedIndex < 80)
                        {
                            richTextBox1.Text = "Атака звуков острая, лёгкая. Между звука-ми есть пауза. Смы-чок отрывается от струн \r\rПриём игры — арко";
                    ...
                    {
                        //21
                        richTextBox1.Text = "Рикошет исполняется броском смычка на струну таким обра-зом, чтобы тот под-прыгнул несколько раз. Количество зву-ков контролируетс \r\rЗдесь рикошет ис-полняется на основе арко";
                        pictureBox1.Image = Resources._221__Рикошет;
                    }
                    else if (listBox1.SelectedIndex < 95)
                    {
                        //22
                        richTextBox1.Text = "Пиццикáто — щипок струны. По умолча-нию осуществляется пальцем правой руки";
                    ...
                    {
                        //24
                        richTextBox1.Text = "Бáртоковское пицци-като — щипок струны с такой силой, чтобы та, возвращаясь, уда-рилась о гриф";
                    ...
                    {
                        //26
                        richTextBox1.Text = "Здесь флажолеты ис-полняются на основе пиццикато";
                    ...
                    {
                        //29
                        richTextBox1.Text = "Коль леньо трáтто — ведение древка смыч-ка по струне";
                    ...
                    else if (listBox1.SelectedIndex < 123)
                    {
                        ...
                        {
                            richTextBox1.Text = "Атака звуков мягкая, сглаженная. Между звуками нет паузы. Смычок не отрывает-ся от струн. Несколь-ко звуков исполняет-ся на одном направ-лении ведения смыч-ка \r\rПриём игры — коль леньо тратто";
                        ...
                        {
                            richTextBox1.Text = "Атака звуков под-чёркнутая, смягчён-ная. Между звуками есть микропауза. Смычок не отрывает-ся от струн. Несколь-ко звуков исполняет-ся на одном направ-лении ведения смыч-ка \r\rПриём игры — коль леньо тратто";
                            pictureBox1.Image = Resources._232_3__Короткое_портато;
                        }
                        else if (listBox1.SelectedIndex < 119)
                        {
                            richTextBox1.Text = "Атака звуков отчёт-ливая. Между звука-ми нет паузы. Смы-чок не отрывается от струн. Каждый сле-дующий звук испол-няется другим направлением веде-ния смычка (пооче-рёдно вниз и вверх) \r\rПриём игры — коль леньо тратто";
                            pictureBox1.Image = Resources._232_4__Деташе;
                        }
                        else if (listBox1.SelectedIndex < 120)
                        {
                            richTextBox1.Text = "Атака звуков под-чёркнутая или акцентированная.Между звуками есть микропауза. Смычок не отрывается от струн.Каждый сле-дующий звук испол-няется другим направлением веде - ния смычка(пооче - рёдно вниз и вверх) \r\rПриём игры — коль леньо тратто";
                            pictureBox1.Image = Resources._232_5__Маркато;
                        }
                        else if (listBox1.SelectedIndex < 121)
                        {
                            richTextBox1.Text = "Атака звуков острая и акцентированная.Между звуками есть пауза. Смычок не от - рывается от струн. Каждый следующий звук исполняется дру - гим направлением ведения смычка(по - очерёдно вниз и вверх) \r\rПриём игры — коль леньо тратто";
                            pictureBox1.Image = Resources._232_6__Мартле;
                        }
                        else if (listBox1.SelectedIndex < 122)
                        {
                            richTextBox1.Text = "Атака звуков твёрдая. Между звуками есть пауза. Смычок не от-рывается от струн. Несколько звуков ис-полняется на одном направлении ведения смычка \r\rПриём игры — коль леньо тратто";
                            pictureBox1.Image = Resources._232_7__Стаккато;
                        }
                        else if (listBox1.SelectedIndex < 123)
                        {
                            richTextBox1.Text = "Атака звуков плотная, твёрдая. Между зву-ками есть пауза. Смычок отрывается от струн \r\rПриём игры — коль леньо тратто";
                    ...
                    {
                        //33
                        richTextBox1.Text = "Рикошет исполняется броском смычка на струну таким обра-зом, чтобы тот под-прыгнул несколько раз. Количество зву-ков контролируется \r\rЗдесь рикошет ис-полняется на основе коль леньо ";
                        pictureBox1.Image = Resources._233__Коль_леньо___рикошет;
                    }
                    else if (listBox1.SelectedIndex < 125)
                    {
                        //34
                        richTextBox1.Text = "По умолчанию глис-сандо выполняется с помощью передвиже-ния пальца левой ру-ки вдоль прижимае-мой им струны";
                        pictureBox1.Image = null;
                    }
            ...
            listBox1.SelectedIndexChanged += (s, a) =>
            {
                if (cont == 3)
                {
                    ...
                    {
                        //2
                        richTextBox1.Text = "Каждая струна звучит в своём низком регистре, поскольку левая рука находится в низкой по-зиции \r\rПриём игры — арко";
                        if (listBox1.SelectedIndex < 2)
                        {
                            pictureBox1.Image = null;
                        }
                    ...
                    {
                        //3
                        richTextBox1.Text = "Первая струна звучит в своём низком регистре (низкая позиция левой руки), вторая — в сред-нем (средняя позиция) \r\rПриём игры — арко";
                        if (listBox1.SelectedIndex < 7)
                        {
                            pictureBox1.Image = null;
                        }
                    ...
                    {
                        //4
                        richTextBox1.Text = "Вторая струна звучит в своём низком регистре (низкая позиция левой руки), третья — в сред-нем (средняя позиция) \r\rПриём игры — арко";
                    ...
                    {
                        //5
                        richTextBox1.Text = "Третья струна звучит в своём низко-среднем регистре (низкая и сред-няя позиции левой ру-ки), четвёртая — в высо-ком (высокая позиция) \r\rПриём игры — арко";
                    ...
                    {
                        //6
                        richTextBox1.Text = "Сурдина — это приспо-собление в форме гре-бешка, шайбы или ба-бочки, надеваемое на подставку или пристав-ляемое к ней со стороны подгрифника. Наиболее крупные сурдины из ме-талла или резины в фор-ме гребешка называются глушителями и исполь-зуются в основном в бы-товых, а не художе-ственных целях \r\rКак правило, компози-торы не уточняют в но-тах материал сурдины, хотя от него во многом зависит итоговое звуча-ние. Установка сурдины обозначается con sord., снятие — senza sord. или via sord. \r\rПриём игры — арко";
                    ...
                    {
                        //9
                        richTextBox1.Text = "При флаутандо смычок очень легко касается струны и ведётся с вы-сокой скоростью \r\rОсновной приём игры — арко";
                        pictureBox1.Image = Resources._309__Переход_к_флаутандо;
                    }
                    else if (listBox1.SelectedIndex < 37)
                    {
                        //10
                        richTextBox1.Text = "Пережим противополо-жен флаутандо \r\rЗдесь пережим исполня-ется на основе арко";
                    ...
                    {
                        //11
                        richTextBox1.Text = "Флажолет — это приём игры, который исполня-ется лёгким прикосно-вением пальца к струне в точке её деления на несколько равных отрез-ков. Прикосновение са-мо по себе не произво-дит звукоизвлечение и в данном случае осу-ществляется вместе с арко. В результате из-влекается какой-либо обертон. Кроме того, флажолетом называется сам извлекаемый обер-тон \r\rПрикосновение к струне в точке её деления на два равных отрезка при-водит к извлечению ок-тавного обертона (и зву-чанию струны на октаву выше). Прикосновение в одной из точек деления на три равных отрезка приводит к извлечению квинтового обертона (и звучанию струны на дуодециму выше) и т. д. \r\rНатуральный флажолет исполняется на откры-той струне";
                        if (listBox1.SelectedIndex < 38)
                        {
                            pictureBox1.Image = null;
                        }
                    ...
                    {
                        //12
                        richTextBox1.Text = "Глиссандо выполняется с помощью передвиже-ния пальца левой руки вдоль струны \r\rЗдесь глиссандо и фла-жолеты исполняются на основе арко";
                    ...
                    else if (listBox1.SelectedIndex < 58)
                    {
                        ...
                        {
                            richTextBox1.Text = "Атака звуков мягкая, сглаженная. Между зву-ками нет паузы. Смычок не отрывается от струн. Несколько звуков ис-полняется на одном направлении ведения смычка\r\rПриём игры — арко";
                        ...
                        {
                            richTextBox1.Text = "Атака звуков подчёрк-нутая, смягчённая. Между звуками есть микропауза. Смычок не отрывается от струн. Не-сколько звуков исполня-ется на одном направле-нии ведения смычка \r\rПриём игры — арко";
                            pictureBox1.Image = Resources._313_3__Короткое_портато;
                        }
                        else if (listBox1.SelectedIndex < 52)
                        {
                            richTextBox1.Text = "Атака звуков отчётли-вая. Между звуками нет паузы. Смычок не отры-вается от струн. Каждый следующий звук испол-няется другим направ-лением ведения смычка (поочерёдно вниз и вверх)\r\rПриём игры — арко";
                            pictureBox1.Image = Resources._313_4__Деташе;
                        }
                        else if (listBox1.SelectedIndex < 53)
                        {
                            richTextBox1.Text = "Атака звуков подчёрк-нутая или акцентированная.Меж - ду звуками есть микро - пауза.Смычок не отры-вается от струн. Каждый следующий звук испол-няется другим направ-лением ведения смычка(поочерёдно вниз и вверх) \r\rПриём игры — арко";
                            pictureBox1.Image = Resources._313_5__Маркато;
                        }
                        else if (listBox1.SelectedIndex < 54)
                        {
                            richTextBox1.Text = "Атака звуков острая и акцентированная.Меж - ду звуками есть пауза.Смычок не отрывается от струн.Каждый сле-дующий звук исполня-ется другим направле-нием ведения смычка(поочерёдно вниз и вверх) \r\rПриём игры — арко";
                            pictureBox1.Image = Resources._313_6__Мартле;
                        }
                        else if (listBox1.SelectedIndex < 55)
                        {
                            richTextBox1.Text = "Атака звуков очень ост-рая. Между звуками есть пауза. Смычок отскаки-вает от струн. Каждый следующий звук испол-няется другим направ-лением ведения смычка (поочерёдно вниз и вверх)\r\rПриём игры — арко";
                            pictureBox1.Image = Resources._313_7__Спиккато;
                        }
                        else if (listBox1.SelectedIndex < 56)
                        {
                            richTextBox1.Text = "Атака звуков твёрдая. Между звуками есть па-уза. Смычок не отрыва-ется от струн. Несколько звуков исполняется на одном направлении ве-дения смычка \r\rПриём игры — арко";
                            pictureBox1.Image = Resources._313_8__Стаккато;
                        }
                        else if (listBox1.SelectedIndex < 57)
                        {
                            richTextBox1.Text = "Атака звуков плотная, твёрдая. Между звуками есть пауза. Смычок от-рывается от струн \r\rПриём игры — арко";
                            pictureBox1.Image = Resources._313_9__Всё_вниз;
                        }
                        else if (listBox1.SelectedIndex < 58)
                        {
                            richTextBox1.Text = "Атака звуков острая, лёгкая. Между звуками есть пауза. Смычок от-рывается от струн \r\rПриём игры — арко";
                    ...
                    {
                        //14
                        richTextBox1.Text = "Рикошет исполняется броском смычка на струну таким образом, чтобы тот подпрыгнул несколько раз. Количе-ство звуков контролиру-ется \r\rЗдесь рикошет исполня-ется на основе арко";
                    ...
                    else if (listBox1.SelectedIndex < 63)
                    {
                        ...
                        {
                            richTextBox1.Text = "Бартоковское пиццикато — щипок струны с та-кой силой, чтобы та, возвращаясь, ударилась о гриф";
                    ...
                    else if (listBox1.SelectedIndex < 76)
                    {
                        ...
                        {
                            richTextBox1.Text = "Атака звуков мягкая, сглаженная. Между зву-ками нет паузы. Смычок не отрывается от струн. Несколько звуков ис-полняется на одном направлении ведения смычка \r\rПриём игры — коль ле-ньо тратто";
                            pictureBox1.Image = Resources._319_1__Короткое_легато;
                        }
                        else if (listBox1.SelectedIndex < 72)
                        {
                            richTextBox1.Text = "Атака звуков подчёрк-нутая, смягчённая. Между звуками есть микропауза. Смычок не отрывается от струн. Не-сколько звуков исполня-ется на одном направле-нии ведения смычка \r\rПриём игры — коль ле-ньо тратто";
                            pictureBox1.Image = Resources._319_2__Короткое_портато;
                        }
                        else if (listBox1.SelectedIndex < 73)
                        {
                            richTextBox1.Text = "Атака звуков отчётли-вая. Между звуками нет паузы. Смычок не отры-вается от струн. Каждый следующий звук испол-няется другим направ-лением ведения смычка (поочерёдно вниз и вверх) \r\rПриём игры — коль ле-ньо тратто";
                            pictureBox1.Image = Resources._319_3__Деташе;
                        }
                        else if (listBox1.SelectedIndex < 74)
                        {
                            richTextBox1.Text = "Атака звуков острая и акцентированная.Меж - ду звуками есть пауза.Смычок не отрывается от струн.Каждый сле-дующий звук исполня-ется другим направле-нием ведения смычка(поочерёдно вниз и вверх) \r\rПриём игры — коль ле-ньо тратто";
                            pictureBox1.Image = Resources._319_4__Мартле;
                        }
                        else if (listBox1.SelectedIndex < 75)
                        {
                            richTextBox1.Text = "Атака звуков плотная, твёрдая. Между звуками есть пауза. Смычок от-рывается от струн \r\rПриём игры — коль ле-ньо тратто";
            ...
            listBox1.SelectedIndexChanged += (s, a) =>
            {
                if (cont == 4)
                {
                    ...
                    {
                        //3
                        richTextBox1.Text = "Первая струна звучит в своём низком реги-стре (низкая позиция левой руки), вторая — в среднем (средняя позиция) \r\rПриём игры — арко";
                        if (listBox1.SelectedIndex < 7)
                        {
                            pictureBox1.Image = null;
                        }
                    ...
                    {
                        //4
                        richTextBox1.Text = "Вторая струна звучит в своём низком реги-стре (низкая позиция левой руки), третья — в среднем и высоком (средняя и высокая позиции) \r\rПриём игры — арко";
                        if (listBox1.SelectedIndex < 10)
                        {
                            pictureBox1.Image = null;
                        }
                    ...
                    {
                        //5
                        richTextBox1.Text = "Третья струна звучит в своём низком реги-стре (низкая позиция левой руки), четвёр-тая — в среднем и высоком (средняя и высокая позиции) \r\rПриём игры — арко";
                        if (listBox1.SelectedIndex < 13)
                        {
                            pictureBox1.Image = null;
                        }
                    ...
                    {
                        //6
                        richTextBox1.Text = "Сурдина — это при-способление в форме гребешка, шайбы или бабочки, надеваемое на подставку или приставляемое к ней со стороны подгриф-ника. Наиболее круп-ные сурдины из ме-талла или резины в форме гребешка называются глушите-лями и используются в основном в быто-вых, а не художе-ственных целях\r\rКак правило, компо-зиторы не уточняют в нотах материал сур-дины, хотя от него во многом зависит ито-говое звучание. Уста-новка сурдины обо-значается con sord., снятие — senza sord. или via sord.\r\rПриём игры — арко";
                    ...
                    {
                        //10
                        richTextBox1.Text = "При флаутандо смы-чок очень легко каса-ется струны и ведётся с высокой скоростью  \r\rОсновной приём игры — арко";
                        pictureBox1.Image = Resources._410__Переход_к_флаутандо;
                    }
                    else if (listBox1.SelectedIndex < 32)
                    {
                        //11
                        richTextBox1.Text = "Пережим противопо-ложен флаутандо \r\rЗдесь пережим ис-полняется на основе арко";
                        pictureBox1.Image = Resources._411__Пережим_усиливающийся;
                    }
                    else if (listBox1.SelectedIndex < 33)
                    {
                        //12
                        richTextBox1.Text = "По умолчанию глис-сандо выполняется с помощью передвиже-ния пальца левой ру-ки вдоль прижимае-мой им струны \r\rЗдесь глиссандо ис-полняется на основе арко";
                        pictureBox1.Image = null;
                    }
                    else if (listBox1.SelectedIndex < 38)
                    {
                        //13
                        richTextBox1.Text = "Флажолет — это при-ём игры, который ис-полняется лёгким прикосновением пальца к струне в точке её деления на несколько равных от-резков. Прикоснове-ние само по себе не производит звукоиз-влечение и в данном случае осуществляет-ся вместе с арко. В результате извлекает-ся какой-либо обер-тон. Кроме того, флажолетом называ-ется сам извлекаемый обертон \r\rПрикосновение к струне в точке её де-ления на два равных отрезка приводит к извлечению октавно-го обертона (и звуча-нию струны на октаву выше). Прикоснове-ние в одной из точек деления на три рав-ных отрезка приводит к извлечению квинто-вого обертона (и зву-чанию струны на дуодециму выше) и т. д.";
                    ...
                    {
                        //14
                        richTextBox1.Text = "По умолчанию глис-сандо выполняется с помощью передвиже-ния пальца левой ру-ки вдоль прижимае-мой им струны \r\rЗдесь глиссандо и флажолеты исполня-ются на основе арко";
                    ...
                    {
                        //17
                        richTextBox1.Text = "Рикошет исполняется броском смычка на струну таким обра-зом, чтобы тот под-прыгнул несколько раз. Количество зву-ков контролируется \r\rПриём игры — арко";
                    ...
                    else if (listBox1.SelectedIndex < 61)
                    {
                        ...
                        else if (listBox1.SelectedIndex < 58)
                        {
                            ...
                            richTextBox1.Text = "Пиццикато — щипок струны. По умолча-нию осуществляется пальцем правой руки";
                        }
                        else if (listBox1.SelectedIndex < 59)
                        {
                            pictureBox1.Image = null;
                        ...
                        else if (listBox1.SelectedIndex < 60)
                        {
                            ...
                            richTextBox1.Text = "Бартоковское пицци-като — щипок струны с такой силой, чтобы та, возвращаясь, уда-рилась о гриф";
                        }
                        else if (listBox1.SelectedIndex < 61)
                        {
                            pictureBox1.Image = null;
                    ...
                    {
                        //22
                        richTextBox1.Text = "Коль леньо тратто — ведение древка смыч-ка по струне";
                    ...
                    else if (listBox1.SelectedIndex < 81)
                    {
                        ...
                        {
                            richTextBox1.Text = "Атака звуков очень острая. Между звука-ми есть пауза. Смы-чок отскакивает от струн. Каждый сле-дующий звук испол-няется другим направлением веде-ния смычка (пооче-рёдно вниз и вверх) \r\rПриём игры — коль леньо тратто";
            ...
            listBox1.SelectedIndexChanged += (s, a) =>
            {
                if (cont == 5)
                {
                    ...
                    {
                        //2
                        richTextBox1.Text = "Каждая струна звучит в своём низком регистре, поскольку левая рука находится в низкой пози-ции\r\rПриём игры — арко ";
                        if (listBox1.SelectedIndex < 2)
                        {
                            pictureBox1.Image = null;
                        }
                    ...
                    {
                        //5
                        richTextBox1.Text = "При флаутандо смычок очень легко касается струны и ведётся с высо-кой скоростью  \r\rЗдесь флаутандо испол-няется на основе арко";
                        pictureBox1.Image = Resources._505__Переход_к_флаутандо;
                    }
                    else if (listBox1.SelectedIndex < 22)
                    {
                        //6
                        richTextBox1.Text = "Флажолет — это приём игры, который исполня-ется лёгким прикоснове-нием пальца к струне в точке её деления на не-сколько равных отрезков. Прикосновение к струне в точке её деления на два равных отрезка приводит к извлечению октавного обертона (и звучанию струны на октаву выше). Прикосновение в одной из точек деления на три равных отрезка приводит к извлечению квинтового обертона (и звучанию струны на дуодециму выше) и т. д. \r\rНатуральный флажолет исполняется на открытой струне";
                        if (listBox1.SelectedIndex < 18)
                        {
                            pictureBox1.Image = null;
                        }
                    ...
                    {
                        //7
                        richTextBox1.Text = "Глиссандо выполняется с помощью передвижения пальца левой руки вдоль струны \r\rЗдесь глиссандо и флажо-леты исполняются на ос-нове арко";
                        pictureBox1.Image = Resources._507__Глиссандо_натуральными_флажолетами;
                    }
                    else if (listBox1.SelectedIndex < 28)
                    {
                        //8
                        richTextBox1.Text = "Здесь флажолеты испол-няются на основе арко";
                    ...
                    else if (listBox1.SelectedIndex < 38)
                    {
                        ...
                        {
                            richTextBox1.Text = "Атака звуков мягкая, сглаженная. Между зву-ками нет паузы. Смычок не отрывается от струн. Несколько звуков испол-няется на одном направ-лении ведения смычка\r\rПриём игры — арко";
                            pictureBox1.Image = Resources._509_1__Легато;
                        }
                        else if (listBox1.SelectedIndex < 31)
                        {
                            richTextBox1.Text = "Атака звуков подчёркну-тая, смягчённая. Между звуками есть микропауза. Смычок не отрывается от струн. Несколько звуков исполняется на одном направлении ведения смычка\r\rПриём игры — арко";
                            pictureBox1.Image = Resources._509_2__Портато;
                        }
                        else if (listBox1.SelectedIndex < 32)
                        {
                            richTextBox1.Text = "Атака звуков отчётливая. Между звуками нет пау-зы. Смычок не отрывается от струн. Каждый следу-ющий звук исполняется другим направлением ве-дения смычка (поочерёд-но вниз и вверх)\r\rПриём игры — арко";
                            pictureBox1.Image = Resources._509_3__Деташе;
                        }
                        else if (listBox1.SelectedIndex < 33)
                        {
                            richTextBox1.Text = "Атака звуков подчёркну-тая или акцентированная. Между звуками есть мик-ропауза. Смычок не отры-вается от струн. Каждый следующий звук исполня-ется другим направлени-ем ведения смычка (по-очерёдно вниз и вверх)\r\rПриём игры — арко";
                            pictureBox1.Image = Resources._509_4__Маркато;
                        }
                        else if (listBox1.SelectedIndex < 34)
                        {
                            richTextBox1.Text = "Атака звуков острая и акцентированная.Между звуками есть пауза. Смы - чок не отрывается от струн. Каждый следую-щий звук исполняется другим направлением ве - дения смычка(поочерёд - но вниз и вверх)\r\rПриём игры — арко";
                            pictureBox1.Image = Resources._509_5__Мартле;
                        }
                        else if (listBox1.SelectedIndex < 35)
                        {
                            richTextBox1.Text = "Атака звуков очень ост-рая. Между звуками есть пауза. Смычок отскакива-ет от струн. Каждый сле-дующий звук исполняется другим направлением ве-дения смычка (поочерёд-но вниз и вверх)\r\rПриём игры — арко";
                            pictureBox1.Image = Resources._509_6__Спиккато;
                        }
                        else if (listBox1.SelectedIndex < 36)
                        {
                            richTextBox1.Text = "Атака звуков твёрдая. Между звуками есть пау-за. Смычок не отрывается от струн. Несколько зву-ков исполняется на одном направлении ведения смычка\r\rПриём игры — арко";
                            pictureBox1.Image = Resources._509_7__Стаккато;
                        }
                        else if (listBox1.SelectedIndex < 37)
                        {
                            richTextBox1.Text = "Атака звуков плотная, твёрдая. Между звуками есть пауза. Смычок отры-вается от струн\r\rПриём игры — арко";
                            pictureBox1.Image = Resources._509_8__Всё_вниз;
                        }
                        else if (listBox1.SelectedIndex < 38)
                        {
                            richTextBox1.Text = "Атака звуков острая, лёг-кая. Между звуками есть пауза. Смычок отрывается от струн \r\rПриём игры — арко";
                    ...
                    else if (listBox1.SelectedIndex < 43)
                    {
                        ...
                        {
                            richTextBox1.Text = "Бартоковское пиццикато — щипок струны с такой силой, чтобы та, возвра-щаясь, ударилась о гриф";
                    ...
                    {
                        //11
                        richTextBox1.Text = "Здесь флажолеты испол-няются на основе пицци-като";
                        if (listBox1.SelectedIndex < 44)
                        {
                            pictureBox1.Image = null;
                        }
            ...
            listBox1.SelectedIndexChanged += (s, a) =>
            {
                if (cont == 6)
                {
                    ...
                    {
                        //3
                        richTextBox1.Text = "Первая струна звучит в своём низком регистре (низкая позиция левой руки), каждая следую-щая — в более высоком";
                    ...
                    {
                        //5
                        richTextBox1.Text = "Вибрато образуется при периодических ко-лебаниях звука по вы-соте, громкости и тембру. Один из пара-метров всегда преобла-дает, у струнных ин-струментов — высота. На гитаре вибрато ис-полняется колебатель-ным движением левой руки или её части, ко-торое передаётся паль-цу, прижимающему струну";
                    ...
                    {
                        //6
                        richTextBox1.Text = "По умолчанию глис-сандо выполняется с помощью передвиже-ния пальца левой руки вдоль прижимаемой им струны";
                        pictureBox1.Image = Resources._606__Глиссандо;
                    }
                    else if (listBox1.SelectedIndex < 17)
                    {
                        //7
                        richTextBox1.Text = "Бенд исполняется под-тягиванием или опус-канием струны, прижа-той пальцем левой ру-ки, перпендикулярно грифу. Образуется гладкое глиссандо вверх до полутона";
                        pictureBox1.Image = Resources._607__Бенд;
                    }
                    else if (listBox1.SelectedIndex < 23)
                    {
                        //8
                        richTextBox1.Text = "Флажолет — это приём игры, который испол-няется лёгким прикос-новением пальца к струне в точке её деле-ния на несколько рав-ных отрезков. Прикос-новение само по себе не производит звукоиз-влечение и в данном случае осуществляется вместе с щипком. Сра-зу после щипка прика-сающийся палец дол-жен прервать контакт со струной. В резуль-тате извлекается ка-кой-либо обертон. Кроме того, флажоле-том называется сам из-влекаемый обертон \r\rПрикосновение к струне в точке её деле-ния на два равных от-резка приводит к из-влечению октавного обертона (и звучанию струны на октаву вы-ше). Прикосновение в одной из точек деления на три равных отрезка приводит к извлечению квинтового обертона (и звучанию струны на дуодециму выше) и т. д.";
                        if (listBox1.SelectedIndex < 18)
                        {
                            pictureBox1.Image = null;
                        }
                    ...
                    {
                        //11
                        richTextBox1.Text = "Пиццикато — щипок, производимый свобод-ными пальцами правой руки в то время, как ребро её ладони при-ложено к струнам у подставки";
                        pictureBox1.Image = Resources._611__Пиццикато;
                    }
                    else if (listBox1.SelectedIndex < 29)
                    {
                        //12
                        richTextBox1.Text = "Бартоковское пицци-като — щипок струны с такой силой, чтобы та, возвращаясь, удари-лась о гриф";
                        pictureBox1.Image = Resources._612__Бартоковское_пиццикато;
                    }
                    else if (listBox1.SelectedIndex < 30)
                    {
                        //13
                        richTextBox1.Text = "Техническое легато — приём игры, при кото-ром первый звук из-влекается правой ру-кой, а последующие — только левой. Связка нот, требующая подоб-ного исполнения, пи-шется под лигой";
                        pictureBox1.Image = Resources._613__Техническое_легато;
                    }
                    else if (listBox1.SelectedIndex < 31)
                    {
                        //14
                        richTextBox1.Text = "Расгеáдо — резкий удар какого-либо паль-ца правой руки вверх или вниз по всем или нескольким соседним струнам одновременно";
                        pictureBox1.Image = Resources._614__Расгеадо;
                    }
                    else if (listBox1.SelectedIndex < 32)
                    {
                        //15
                        richTextBox1.Text = "Расгеадо — резкий удар какого-либо паль-ца правой руки вверх или вниз по всем или нескольким соседним струнам одновременно";
                        pictureBox1.Image = Resources._615__Расгеадо_по_скрещённым_струнам;
                    }
                    else if (listBox1.SelectedIndex < 33)
                    {
                        //16
                        richTextBox1.Text = "Тамбури́н ― удар бо-ковой части большого пальца правой руки по всем или нескольким соседним струнам у подставки";
                    ...
                    {
                        //20
                        richTextBox1.Text = "Гóльпе ― удар паль-цем не по струне";
                        pictureBox1.Image = null;
                    }
                }
            };
            ...
            listBox1.SelectedIndexChanged += (s, a) =>
            {
                if (cont == 7)
                {
                    ...
                    {
                        //1
                        richTextBox1.Text = "Приём игры — щи-пок/удар медиатором, или нон тремоло. Это один из двух главных приёмов игры наравне с тремоло медиатором";
                    ...
                    {
                        //3
                        richTextBox1.Text = "Тремоло исполняется быстрым чередованием ударов правой руки вниз-вверх по одной, двум или трём струнам сразу. По умолчанию на всех домрах звук извлекается медиато-ром";
                        if (listBox1.SelectedIndex < 6)
                        {
                            pictureBox1.Image = null;
                        }
                    ...
                    {
                        //4
                        richTextBox1.Text = "Каждая струна звучит в своём низком регистре, поскольку левая рука находится в низкой по-зиции \r\rПриём игры — тремо-ло медиатором";
                        if (listBox1.SelectedIndex < 9)
                        {
                            pictureBox1.Image = null;
                        }
                    ...
                    {
                        //5
                        richTextBox1.Text = "Первая струна звучит в своём низком регистре (низкая позиция левой руки), каждая следую-щая — в более высоком \r\rПриём игры — тремо-ло медиатором";
                        if (listBox1.SelectedIndex < 13)
                        {
                            pictureBox1.Image = null;
                        }
                    ...
                    {
                        //6
                        richTextBox1.Text = "Приём игры — тремо-ло медиатором";
                    ...
                    {
                        //9
                        richTextBox1.Text = "Вибрато образуется при периодических ко-лебаниях звука по вы-соте, громкости и тембру. Один из пара-метров всегда преобла-дает, у струнных ин-струментов — высота";
                    ...
                    {
                        //11
                        richTextBox1.Text = "Флажолет — это приём игры, который испол-няется лёгким прикос-новением пальца к струне в точке её деле-ния на несколько рав-ных отрезков. Прикос-новение само по себе не производит звукоиз-влечение и в данном случае осуществляется вместе с ударом меди-атора. Сразу после зву-коизвлечения прика-сающийся палец дол-жен прервать контакт со струной. В резуль-тате извлекается ка-кой-либо обертон. Кроме того, флажоле-том называется сам из-влекаемый обертон \r\rПрикосновение к струне в точке её деле-ния на два равных от-резка приводит к из-влечению октавного обертона (и звучанию струны на октаву вы-ше). Прикосновение в одной из точек деления на три равных отрезка приводит к извлечению квинтового обертона (и звучанию струны на дуодециму выше) и т. д. \r\rНатуральный флажолет исполняется на откры-той струне ";
                    ...
                    {
                        //13
                        richTextBox1.Text = "Флажолет — это приём игры, который испол-няется лёгким прикос-новением пальца к струне в точке её деле-ния на несколько рав-ных отрезков. Прикос-новение само по себе не производит звукоиз-влечение и в данном случае осуществляется вместе с тремоло ме-диатором. В результате извлекается какой-либо обертон. Кроме того, флажолетом называется сам извле-каемый обертон\r\rПрикосновение к струне в точке её деле-ния на два равных от-резка приводит к из-влечению октавного обертона (и звучанию струны на октаву вы-ше). Прикосновение в одной из точек деления на три равных отрезка приводит к извлечению квинтового обертона (и звучанию струны на дуодециму выше) и т. д.\r\rНатуральный флажолет исполняется на откры-той струне ";
                    ...
                    {
                        //14
                        richTextBox1.Text = "Искусственный фла-жолет исполняется на закрытой струне: один палец прижимает струну, а другой одно-временно к ней прика-сается ";
                    ...
                    {
                        //16
                        richTextBox1.Text = "Большая дробь на дом-ре — быстрая последо-вательность ударов вниз по всем струнам пятым, четвёртым, тре-тьим пальцами и меди-атором. При обратной дроби совершаются удары вверх третьим, четвёртым и пятым пальцами";
            ...
            listBox1.SelectedIndexChanged += (s, a) =>
            {
                if (cont == 9)
                {
                    ...
                    {
                        //3
                        richTextBox1.Text = "По умолчанию на всех дом-рах звук извлекается медиа-тором";
            ...
            listBox1.SelectedIndexChanged += (s, a) =>
            {
                if (cont == 11)
                {
                    ...
                    {
                        //2
                        richTextBox1.Text = "Бря́цание — удар указа-тельного пальца правой руки вниз или вверх по всем струнам одновремен-но";
                        pictureBox1.Image = Resources._8102__Бряцание;
                    }
                    else if (listBox1.SelectedIndex < 3)
                    {
                        //3
                        richTextBox1.Text = "Бряцание — удар указа-тельного пальца правой руки вниз или вверх по всем струнам одновремен-но \r\rСтруна приглушается по-луприжатием её к грифу левой рукой";
                        pictureBox1.Image = Resources._8103__Бряцание_по_приглушённым_струнам;
                    }
                    else if (listBox1.SelectedIndex < 4)
                    {
                        //4
                        richTextBox1.Text = "Тремоло выполняется быстрым чередованием ударов вниз и вверх указа-тельным пальцем правой руки";
                    ...
                    else if (listBox1.SelectedIndex < 9)
                    {
                        ...
                        else if (listBox1.SelectedIndex < 7)
                        {
                            ...
                            richTextBox1.Text = "Двойное пиццикато обра-зуется из последовательно-сти ударов по одной струне: большим пальцем правой руки вниз и указа-тельным пальцем вверх";
                        }
                        else if (listBox1.SelectedIndex < 8)
                        {
                            pictureBox1.Image = Resources._8105_3__Одинарное_пиццикато__переменные_удары_;
                            richTextBox1.Text = "Одинарное пиццикато об-разуется из последователь-ности ударов указательным пальцем правой руки вниз и вверх по одной струне";
                        }
                        else if (listBox1.SelectedIndex < 9)
                        {
                            pictureBox1.Image = Resources._8105_4__Подцеп;
                            richTextBox1.Text = "Подцéп — щипок струны, осуществляемый восходя-щим движением указа-тельного или среднего пальца правой руки";
                        }
                    }
                    else if (listBox1.SelectedIndex < 10)
                    {
                        //6
                        richTextBox1.Text = "Гитарный приём — назва-ние техники, при которой звукоизвлечение произво-дится любыми пальцами правой руки при относи-тельной пассивности кисти и предплечья";
                    ...
                    {
                        //8
                        richTextBox1.Text = "Малая дробь на балалайке — быстрая последователь-ность ударов вниз по всем струнам четырьмя пальца-ми. Большая дробь испол-няется с добавлением удара большого пальца. При об-ратной дроби совершаются удары вверх четырьмя пальцами, кроме большого";
                        if (listBox1.SelectedIndex < 12)
                        {
                            pictureBox1.Image = null;
                        }
                    ...
                    {
                        //9
                        richTextBox1.Text = "Вибрато образуется при периодических колебаниях звука по высоте, громкости и тембру. Один из пара-метров всегда преобладает, у струнных инструментов — высота \r\rНа балалайке вибрато до-стигается следующим спо-собом: ребро правой ладо-ни прикладывается к нуж-ной струне за подставкой и с помощью покачиваний осуществляет периодиче-ские нажимы на подставку и струну";
                    ...
                    {
                        //10
                        richTextBox1.Text = "Флажолет — это приём иг-ры, который исполняется лёгким прикосновением пальца к струне в точке её деления на несколько рав-ных отрезков. Прикоснове-ние само по себе не произ-водит звукоизвлечение и в данном случае осуществля-ется вместе с щип-ком/ударом. Сразу после звукоизвлечения прикаса-ющийся палец должен пре-рвать контакт со струной. В результате извлекается какой-либо обертон. Кроме того, флажолетом называ-ется сам извлекаемый обертон\r\rПрикосновение к струне в точке её деления на два равных отрезка приводит к извлечению октавного обертона (и звучанию струны на октаву выше). Прикосновение в одной из точек деления на три рав-ных отрезка приводит к извлечению квинтового обертона (и звучанию струны на дуодециму вы-ше) и т. д.\r\rНатуральный флажолет исполняется на открытой струне";
                    ...
                    {
                        //11
                        richTextBox1.Text = "Искусственный флажолет исполняется на закрытой струне: один палец при-жимает струну, а другой одновременно к ней прика-сается";
                        pictureBox1.Image = Resources._8111__Искусственные_флажолеты_на_первой_струне_от_основного_тона_до_второй_октавы;
                    }
                    else if (listBox1.SelectedIndex < 27)
                    {
                        //12
                        richTextBox1.Text = "Техническое легато — приём игры, при котором первый звук извлекается правой рукой, а последую-щие — только левой. Связ-ка нот, требующая подоб-ного исполнения, пишется под лигой. Ноты, исполня-емые только левой рукой, отмечаются знаком +";
            ...
            listBox1.SelectedIndexChanged += (s, a) =>
            {
                if (cont == 12)
                {
                    ...
                    {
                        //1
                        richTextBox1.Text = "По умолчанию на балалай-ке секунде звук извлекается медиатором";
                    ...
                    else if (listBox1.SelectedIndex < 4)
                    {
                        ...
                        if (listBox1.SelectedIndex < 2)
                        {
                            pictureBox1.Image = Resources._8202__Без_арпеджиато_и_с_арпеджиато__Хиндемит__Соната_для_арфы;
                        }
                        else if (listBox1.SelectedIndex < 3)
                        {
                    ...
                    {
                        //3
                        richTextBox1.Text = "По умолчанию на бала-лайке секунде звук извле-кается медиатором";
                        if (listBox1.SelectedIndex < 5)
                        {
                            pictureBox1.Image = null;
                        }
            ...
            listBox1.SelectedIndexChanged += (s, a) =>
            {
                if (cont == 13)
                {
                    ...
                    {
                        //1
                        richTextBox1.Text = "По умолчанию на балалай-ке альте звук извлекается медиатором";
                        pictureBox1.Image = Resources._8301__Диапазон;
                    }
                    else if (listBox1.SelectedIndex < 4)
                    {
                        //2
                        richTextBox1.Text = "По умолчанию на бала-лайке альте звук извлека-ется медиатором";
                        if (listBox1.SelectedIndex < 2)
                        {
                            pictureBox1.Image = null;
                        }
                    ...
                    {
                        //5
                        richTextBox1.Text = "Флажолет — это приём иг-ры, который исполняется лёгким прикосновением пальца к струне в точке её деления на несколько рав-ных отрезков. Прикоснове-ние само по себе не произ-водит звукоизвлечение и в данном случае осуществля-ется вместе с щипком. Сра-зу после щипка прикасаю-щийся палец должен пре-рвать контакт со струной. В результате извлекается ка-кой-либо обертон. Кроме того, флажолетом называ-ется сам извлекаемый обер-тон\r\rПрикосновение к струне в точке её деления на два равных отрезка приводит к извлечению октавного обертона (и звучанию струны на октаву выше). Прикосновение в одной из точек деления на три рав-ных отрезка приводит к из-влечению квинтового обер-тона (и звучанию струны на дуодециму выше) и т. д.\r\rНатуральный флажолет исполняется на открытой струне";
                        if (listBox1.SelectedIndex < 11)
                        {
                            pictureBox1.Image = null;
                        }
            ...
            listBox1.SelectedIndexChanged += (s, a) =>
            {
                if (cont == 14)
                {
                    ...
                    {
                        //1
                        richTextBox1.Text = "По умолчанию на балалай-ке контрабасе звук извлека-ется медиатором";
            ...
            listBox1.SelectedIndexChanged += (s, a) =>
            {
                if (cont == 15)
                {
                    ...
                    {
                        //1
                        richTextBox1.Text = "Используется глав-ный приём игры — пиццикато, или щи-пок струны пальцем";
                        pictureBox1.Image = Resources._901__Диапазон;
                    }
                    else if (listBox1.SelectedIndex < 4)
                    {
                        //2
                        richTextBox1.Text = "Существует два спо-соба исполнения ак-корда: арпеджиато или без арпеджиато. Предполагается, что звуки аккорда, запи-санного в нотах без волнистой линии, из-влекаются одновре-менно. Однако арфи-сты нередко приме-няют арпеджиато по своему усмотрению";
                        pictureBox1.Image = Resources._902__Без_арпеджиато_и_с_арпеджиато__Хиндемит__Соната_для_арфы;
                    }
                    else if (listBox1.SelectedIndex < 9)
                    {
                        //3
                        richTextBox1.Text = "Глиссандо исполня-ется проведением од-ного и того же пальца по всем струнам по-следовательно в ука-занном диапазоне";
                    ...
                    {
                        //5
                        richTextBox1.Text = "Флажолет — это при-ём игры, который ис-полняется лёгким прикосновением пальца к струне в точке её деления на несколько равных от-резков. Прикоснове-ние само по себе не производит звукоиз-влечение и в данном случае осуществляет-ся вместе с щипком. Сразу после щипка прикасающийся па-лец должен прервать контакт со струной. В результате извлекает-ся какой-либо обер-тон. Кроме того, флажолетом называ-ется сам извлекаемый обертон\r\rПрикосновение к струне в точке её де-ления на два равных отрезка приводит к извлечению октавно-го обертона (и звуча-нию струны на октаву выше). Прикоснове-ние в одной из точек деления на три рав-ных отрезка приводит к извлечению квинто-вого обертона (и зву-чанию струны на дуодециму выше)";
                        if (listBox1.SelectedIndex < 13)
                        {
                            pictureBox1.Image = null;
                        }
                    ...
                    {
                        //6
                        richTextBox1.Text = "Здесь тремоло испол-няется по принципу «нота/созвучие — од-на рука, следующая нота/созвучие — дру-гая рука и т. д.»";
                        pictureBox1.Image = null;
                    }
                    else if (listBox1.SelectedIndex < 22)
                    {
                        //7
                        richTextBox1.Text = "Тремоло Эола испол-няется пальцами двух рук, совершающими быстрыми поочерёд-ные движения вперёд и назад по струнам в указанном диапазоне";
                        pictureBox1.Image = Resources._907_5;
                    }
                    else if (listBox1.SelectedIndex < 26)
                    {
                        //8
                        richTextBox1.Text = "Педальное глиссандо предполагает извле-чение первого звука с помощью рук, а по-следующих — лишь с помощью смены по-зиции педали";
                    ...
                    {
                        //10
                        richTextBox1.Text = "По умолчанию на ар-фе звук извлекается подушечкой пальца, а не ногтем";
                    ...
                    {
                        //12
                        richTextBox1.Text = "Резкое и сильное скольжение пальцем левой руки от одной металлической стру-ны к другой, в резуль-тате чего струны бьются друг о друга и продолжают звучать";
            ...
            listBox1.SelectedIndexChanged += (s, a) =>
            {
                if (cont == 16)
                {
                    ...
                    {
                        //1
                        richTextBox1.Text = "По умолчанию на кла-вишных гуслях звук из-влекается медиатором";
                        pictureBox1.Image = Resources._1001__Диапазон;
                    }
                    else if (listBox1.SelectedIndex < 4)
                    {
                        //2
                        richTextBox1.Text = "Арпеджиато — главный приём игры. По умолча-нию осуществляется проведением медиатора по всем струнам после-довательно в указанном диапазоне, при этом звучит лишь часть отыг-рываемых струн — та, что освобождена от демпферов";
                        if (listBox1.SelectedIndex < 2)
                        {
                            pictureBox1.Image = null;
                        }
                    ...
                    {
                        //6
                        richTextBox1.Text = "Глиссандо исполняется проведением медиатора по всем струнам после-довательно в указанном диапазоне. При этом звучат все отыгрывае-мые струны, это дости-гается нажатием рычага или всех клавиш";
                    ...
                    {
                        //11
                        richTextBox1.Text = "Флажолет — это приём игры, который исполня-ется лёгким прикосно-вением пальца к струне в точке её деления на несколько равных отрез-ков. Прикосновение са-мо по себе не произво-дит звукоизвлечение и в данном случае осу-ществляется вместе с щипком/ударом. Сразу после звукоизвлечения прикасающийся палец должен прервать кон-такт со струной. В ре-зультате извлекается ка-кой-либо обертон. Кро-ме того, флажолетом называется сам извлека-емый обертон\r\rПрикосновение к струне в точке её деления на два равных отрезка при-водит к извлечению ок-тавного обертона (и зву-чанию струны на октаву выше)";
